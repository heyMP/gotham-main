...
[![Build Status](https://travis-ci.org/heyMP/gotham-main.svg?branch=master)](https://travis-ci.org/heyMP/gotham-main)
[![Dependency Status](https://img.shields.io/david/heyMP/gotham-main.svg?style=flat)](https://david-dm.org/heyMP/gotham-main)
[![Published on webcomponents.org](https://img.shields.io/badge/webcomponents.org-published-blue.svg)](https://www.webcomponents.org/author/heyMP)
Welcome to the gotham-main project!
Standard element library for Gotham University
## Quick-start
...
```bash
$ git clone git@github.com:heyMP/gotham-main.git
$ cd gotham-main
$ yarn install
$ yarn start
```
